  ...
  if (isset($_POST['submit_authentification'])) { // si $_POST['submit'] est défini, il s'agit du formulaire de connexion qui a été soumis pour traitement
    ...
    if ($requete = $connection->prepare("SELECT mot_de_passe FROM utilisateurs WHERE utilisateur_login = ?")) {
        ...
        if($requete->execute()) {
          ...
          $requete->bind_result($_mot_de_passe);
          $requete->fetch(); 
          if(password_verify($mot_de_passe, $_mot_de_passe)) {
...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="http://www.les100ciel.info">Les100Ciel</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item <?php if($page=='À propos') echo 'active'; ?>">
            <a class="nav-link" href="enonce.php">À propos</a>
          </li>
          <li class="nav-item dropdown <?php if($page=='Nouvelles catégories' || $page=='Nouvelles') echo 'active'; ?>">
		  ...
		  <li class="nav-item <?php if($page=='Module personnel') echo 'active'; ?>">
          ...
          <li class="nav-item dropdown <?php if($page=='Administration nouvelles' || $page=='') echo 'active'; ?>">
          ...
          <li class="nav-item">
              <form method="POST">
                <button class="btn btn-outline-info my-2 my-sm-0" type="submit" name="seDeconnecter" >Déconnexion</button>
              </form>					
          </li>
